    ...
    return (
        <div className="min-h-screen bg-gray-50/50 pt-8 pb-32">
            <div className="max-w-4xl mx-auto flex flex-col md:flex-row gap-4 relative px-2 md:px-4">
                                                            ...
                                                            <div className="flex flex-col gap-3">
                                                                <div className="flex gap-2 w-full items-center">
                                                                    <input
                                                                        ...
                                                                        className="flex-1 text-sm outline-none px-3 py-2 bg-gray-50 border border-gray-200 rounded text-gray-600 focus:border-school-primary focus:bg-white"
                                                                        value={block.image_url || ''}
                                                                        onChange={(e) => updateBlock(block.id, 'image_url', e.target.value)}
                                                                    />
                                                                    <span className="text-gray-400 text-xs font-medium uppercase px-2">OR</span>
                                                                    <label className="cursor-pointer text-sm font-semibold uppercase tracking-wide bg-school-primary text-white border border-transparent hover:bg-school-secondary px-3 py-2 rounded shrink-0 shadow-sm transition-colors flex items-center gap-1.5">
                ...
                <div className="fixed bottom-4 left-1/2 -translate-x-1/2 md:translate-x-0 md:static md:w-14 md:shrink-0 md:mt-0 z-[100]">
