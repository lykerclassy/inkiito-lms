            ...
            <div className="space-y-8">
                {blocks.map((block) => (
                    <div key={block.id} className="block-container">
                        ...
                        {/* TEXT BLOCK */}
                        {block.type === 'text' && (
                            <Card className="prose max-w-none prose-blue p-8 shadow-sm border border-gray-100">
                        ...
                        {/* IMAGE BLOCK */}
                        {block.type === 'image' && (
                            <Card noPadding={true} className="overflow-hidden shadow-sm border border-gray-100 bg-gray-50 flex flex-col items-center">
                                <img 
                                ...
                                {block.content.caption && (
                                    <div className="w-full p-4 bg-white border-t border-gray-100 text-center text-sm text-gray-600 italic">
                                        {block.content.caption}
                                    </div>
                                )}
                            </Card>
                        ...
                        {block.type === 'code_editor' && (
                            <Card className="shadow-sm border border-gray-200 overflow-hidden" noPadding={true}>
