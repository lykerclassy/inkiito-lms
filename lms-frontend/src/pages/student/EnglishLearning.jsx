                        ...
                        <div className="max-w-2xl mx-auto">
                            <Card className="text-center py-5 shadow-sm relative overflow-hidden ring-4 ring-blue-50">
                                ...
                                <div className="space-y-4">
                                    <button
                                        className="w-full py-3 rounded-3xl border-4 border-dashed border-blue-200 hover:border-blue-500 hover:bg-blue-50 transition-all flex flex-col items-center gap-3 group"
                                        onClick={() => speak(wordData.word)}
                                    >
                                        ...
                                        <span className="text-sm font-semibold text-blue-600">Listen to Instruction</span>
                                    </button>
